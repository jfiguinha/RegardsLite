...
LinkOptions            :=  
IncludePath            := $(IncludeSwitch)$${HOME}/developpement/git/RegardsLite/libextern/oneapi-tbb-2022.0.0/include/tbb $(IncludeSwitch)$${HOME}/developpement/git/Regards/libextern/ffmpeg-master/include $(IncludeSwitch)$${HOME}/developpement/git/Regards/libextern/vcpkg/installed/x64-linux/include/opencv4 $(IncludeSwitch)$${HOME}/developpement/git/Regards/libextern/vcpkg/installed/x64-linux/include/Imath $(IncludeSwitch)$${HOME}/developpement/git/Regards/libextern/vcpkg/installed/x64-linux/include/libde265 $(IncludeSwitch)$${HOME}/developpement/git/Regards/libextern/vcpkg/installed/x64-linux/include/poppler $(IncludeSwitch)$${HOME}/developpement/git/Regards/libextern/vcpkg/installed/x64-linux/include/poppler/cpp $(IncludeSwitch)$${HOME}/developpement/git/Regards/libextern/vcpkg/installed/x64-linux/include $(IncludeSwitch)$${HOME}/ffmpeg_build/include $(IncludeSwitch)/usr/include/pango-1.0 $(IncludeSwitch)/usr/include/glib-2.0 $(IncludeSwitch)/usr/lib/glib-2.0/include $(IncludeSwitch)/usr/lib/x86_64-linux-gnu/glib-2.0/include $(IncludeSwitch)/usr/include/cairo $(IncludeSwitch)/usr/include/SDL2 $(IncludeSwitch)/usr/include $(IncludeSwitch)/usr/include/harfbuzz  $(IncludeSwitch). $(IncludeSwitch)../libCompress $(IncludeSwitch)../libSqlite $(IncludeSwitch)../libUtility $(IncludeSwitch)../libResource $(IncludeSwitch)../libPicture $(IncludeSwitch)../CxImage $(IncludeSwitch)../libFiltre $(IncludeSwitch)../libextern/libjpeg-turbo-1.5.1 $(IncludeSwitch)../libExif $(IncludeSwitch)../include $(IncludeSwitch)../libextern/libRapidXML $(IncludeSwitch). 
IncludePCH             :=  -include Release/header.h 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
LibPath                :=$(LibraryPathSwitch)$${HOME}/developpement/git/RegardsLite/libextern/oneapi-tbb-2022.0.0/lib/intel64 $(LibraryPathSwitch)$${HOME}/developpement/git/Regards/libextern/ffmpeg-master/lib $(LibraryPathSwitch)$${HOME}/developpement/git/Regards/libextern/vcpkg/installed/x64-linux/lib $(LibraryPathSwitch)$${HOME}/developpement/git/Regards/libextern/vcpkg/installed/x64-linux/lib/manual-link/opencv4_thirdparty $(LibraryPathSwitch)$${HOME}/ffmpeg_build/lib $(LibraryPathSwitch)/usr/local/cuda/lib64 $(LibraryPathSwitch)/usr/lib/x86_64-linux-gnu $(LibraryPathSwitch)/lib/llvm-18/lib  $(LibraryPathSwitch). 
