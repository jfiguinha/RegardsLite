...
#define IDM_FILTRE_DETAILENHANCE 46
#define IDM_FILTRE_EDGEPRESERVING 47
#define IDM_FILTRE_PENCILSKETCH 48
#define IDM_FILTRE_STYLISATION 49

#define FILTER_END 50
#define IDM_OCR 99
