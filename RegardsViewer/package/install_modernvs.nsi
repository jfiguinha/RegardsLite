...
;--------------------------------
;General
!define MUI_PRODUCT "RegardsLite Viewer 2.0.0.5"
...
;--------------------------------
;Installer Sections
Section "RegardsLite Viewer 2.0.0.5" SecRegardsViewer
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRegardsViewer ${LANG_ENGLISH} "Regards Viewer 2.0.0.5"
