...
;--------------------------------
;General
!define MUI_PRODUCT "RegardsLite Viewer 2.0.1.0"
...
;--------------------------------
;Installer Sections
Section "RegardsLite Viewer 2.0.1.0" SecRegardsViewer
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRegardsViewer ${LANG_ENGLISH} "Regards Viewer 2.0.1.0"
