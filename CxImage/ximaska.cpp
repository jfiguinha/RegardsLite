...
bool CxImageSKA::Decode(CxFile* hFile)
{
	...
	auto ppal = static_cast<rgb_color*>(malloc(nColors * sizeof(rgb_color)));
...
bool CxImageSKA::Encode(CxFile* hFile)
{
	...
	ska_header.Width = static_cast<uint16_t>(GetWidth());
	ska_header.Height = static_cast<uint16_t>(GetHeight());
	ska_header.BppExp = 3;
