...
#pragma pack(1)
	...
	using struct_gifgce = struct tag_gifgce
	{
	...
	using struct_dscgif = struct tag_dscgif
	{
	...
	using struct_image = struct tag_image
	{
		/* Image Descriptor */
		uint16_t l;
		uint16_t t;
	...
	using struct_TabCol = struct tag_TabCol
	{
		/* Tabla de colores */
	...
	using struct_RLE = struct tag_RLE
	{
		int32_t rl_pixel;
		int32_t rl_basecode;
		int32_t rl_count;
