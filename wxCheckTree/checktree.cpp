...
wxCheckTree::wxCheckTree(): wxTreeCtrl(), mouse_entered_tree_with_left_down(false), last_mo(), last_ld(), last_kf()
{
}

wxCheckTree::wxCheckTree(wxWindow* parent, const wxWindowID id, const wxPoint& pos, const wxSize& size, long style)
	: wxTreeCtrl(parent, id, pos, size, style)
	  , mouse_entered_tree_with_left_down(false), last_mo(), last_ld(), last_kf()
{
	Init();
}
