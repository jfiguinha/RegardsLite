...
bool WebApp::OnInit()
{
    ...
    WebFrame *frame = new WebFrame("https://www.google.com");
    frame->Show();
    ...
    wxFrame(NULL, wxID_ANY, "wxWebView Sample")
{
    ...
    // Create find control.
    m_find_ctrl = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(140,-1), wxTE_PROCESS_ENTER);
