...
CVideoFilter::CVideoFilter()
{
	...
	effectDenoisingSigmaU = CLibResource::LoadStringFromResource(L"LBLeffectDenoisingSigmaU", 1);
	//L"Effect.Denoising.Sigma P";
	effectDenoisingThreshold = CLibResource::LoadStringFromResource(L"LBLeffectDenoisingThreshold", 1);
	// L"Effect.Denoising.FSize";
	effectDenoisingSigmaK = CLibResource::LoadStringFromResource(L"LBLeffectDenoisingSigmaK", 1);
	//L"Effect.Denoising.Sigma X";
	...
	toneBrightnessLevel = CLibResource::LoadStringFromResource(L"LBLtoneBrightnessLevel", 1);
	//L"Tone.Brightness.Level";
	...
	enableDenoiseEffect = CLibResource::LoadStringFromResource(L"LBLenableDenoiseEffect", 1);
	//L"Effect.Denoising.Enable";
	enableOpenglDenoising = CLibResource::LoadStringFromResource(L"LBLenableOpenGLDenoiseEffect", 1);
	//L"Effect.Denoising.Enable";
	enableSharpenEffect = CLibResource::LoadStringFromResource(L"LBLenableSharpenEffect", 1);
	//L"Effect.Sharpen.Enable";
...
void CVideoFilter::Filter(CEffectParameter* effectParameter, cv::Mat& source, const wxString& filename,
...
void CVideoFilter::Filter(CEffectParameter* effectParameter, const wxString& filename,
                          IFiltreEffectInterface* filtreInterface)
{
	...
	*/
	...
	filtreInterface->AddTreeInfos(libelleScale, new CTreeElementValueInt(videoEffectParameter->ratioSelect),
	                              &formatPicture, 3, 3);
	filtreInterface->AddTreeInfos(showFPS, new CTreeElementValueInt(videoEffectParameter->showFPS),
	...
	filtreInterface->AddTreeInfos(enableBandCEffect, new CTreeElementValueInt(videoEffectParameter->bandcEnable),
	                              &videoEffectParameter->bandcEnable, 2, 2);
	filtreInterface->AddTreeInfos(toneConstrastLevel, new CTreeElementValueInt(videoEffectParameter->contrast),
	                              &elementContrast);
	filtreInterface->AddTreeInfos(toneBrightnessLevel, new CTreeElementValueInt(videoEffectParameter->brightness),
	                              &elementContrast);
	...
	filtreInterface->AddTreeInfos(libelleStabilize, new CTreeElementValueInt(videoEffectParameter->stabilizeVideo),
	                              &videoEffectParameter->stabilizeVideo, 2, 2);
	filtreInterface->AddTreeInfos(libelleStabilizeNbFrame,
	                              new CTreeElementValueInt(videoEffectParameter->stabilizeImageBuffere),
	                              &elementFreqStab);
	...
	filtreInterface->AddTreeInfos(enableSharpenEffect, new CTreeElementValueInt(videoEffectParameter->SharpenEnable),
	                              &videoEffectParameter->SharpenEnable, 2, 2);
	filtreInterface->AddTreeInfos(effectSharpenLevel, new CTreeElementValueInt(videoEffectParameter->sharpness),
	                              &elementFreq);
	...
	filtreInterface->AddTreeInfos(enableColorEffect, new CTreeElementValueInt(videoEffectParameter->ColorBoostEnable),
	                              &videoEffectParameter->ColorBoostEnable, 2, 2);
	filtreInterface->AddTreeInfos(colorBoostRed, new CTreeElementValueInt(videoEffectParameter->color_boost[0]),
	                              &elementColor);
	filtreInterface->AddTreeInfos(colorBoostGreen, new CTreeElementValueInt(videoEffectParameter->color_boost[1]),
	                              &elementColor);
	filtreInterface->AddTreeInfos(colorBoostBlue, new CTreeElementValueInt(videoEffectParameter->color_boost[2]),
	                              &elementColor);
	...
	filtreInterface->AddTreeInfos(enableDenoiseEffect, new CTreeElementValueInt(videoEffectParameter->denoiseEnable),
	...
	filtreInterface->AddTreeInfos(effectDenoisingSigmaU, new CTreeElementValueFloat(videoEffectParameter->uSigma),
	                              &elementSigma, 4);
	filtreInterface->AddTreeInfos(effectDenoisingThreshold,
	                              new CTreeElementValueFloat(videoEffectParameter->uThreshold), &elementDenoiseLevel,
	                              4);
...
void CVideoFilter::FilterChangeParam(CEffectParameter* effectParameter, CTreeElementValue* valueData,
                                     const wxString& key)
{
	auto videoEffectParameter = static_cast<CVideoEffectParameter*>(effectParameter);
