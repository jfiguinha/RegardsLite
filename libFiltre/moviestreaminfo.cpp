...
void MovieStreamInfo::initializeVideo()
{
	...
	int indexVideo = av_find_best_stream(m_pFormatContext, AVMEDIA_TYPE_VIDEO, wanted_stream[AVMEDIA_TYPE_VIDEO], -1,
	                                     nullptr, 0);
	int indexAudio = av_find_best_stream(m_pFormatContext, AVMEDIA_TYPE_AUDIO, wanted_stream[AVMEDIA_TYPE_AUDIO], -1,
	                                     nullptr, 0);
	int indexSubtitle = av_find_best_stream(m_pFormatContext, AVMEDIA_TYPE_SUBTITLE,
	                                        wanted_stream[AVMEDIA_TYPE_SUBTITLE], -1, nullptr, 0);
