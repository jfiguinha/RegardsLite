...
if [[ $OSTYPE == 'darwin'* ]]; then
	...
	/Volumes/WD_BLACK/developpement/git/RegardsLite/libextern/vcpkg/installed/arm64-osx/tools/wxwidgets/wx-config --libs
else
...
#    ${HOME}/developpement/git/Regards/libextern/wxWidgets-3.2.3/build_new/wx-config --libs
    ${HOME}/developpement/git/RegardsLite/libextern/vcpkg/installed/x64-linux/tools/wxwidgets/wx-config --libs
fi
