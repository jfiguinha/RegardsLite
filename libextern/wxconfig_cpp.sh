...
if [[ $OSTYPE == 'darwin'* ]]; then
	...
	/Volumes/WD_BLACK/developpement/git/RegardsLite/libextern/vcpkg/installed/arm64-osx/tools/wxwidgets/wx-config --cppflags
else
#	${HOME}/ffmpeg_build/bin/wx-config --cppflags
    ${HOME}/developpement/git/RegardsLite/libextern/vcpkg/installed/x64-linux/tools/wxwidgets/wx-config --cppflags
